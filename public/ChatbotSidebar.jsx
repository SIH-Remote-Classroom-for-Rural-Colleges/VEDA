/* global React */
// ChatbotSidebar.jsx - Bilingual (English/Hindi) lightweight chatbot widget
// This version is browser-ready via CDN React + Babel (no build step required)

const { useEffect, useMemo, useRef, useState } = React;

function ChatbotSidebar({ apiBaseUrl = "", initialLang = "en", title, maxMessages = 50 }) {
...
// Expose globally so it can be used in index.html inline JSX
